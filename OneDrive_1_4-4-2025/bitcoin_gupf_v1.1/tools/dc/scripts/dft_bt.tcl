...
set_scan_configuration -voltage_mixing false -power_domain_mixing true -reuse_mv_cells false
set_scan_path 1 -scan_data_in sipo_scan_in -scan_data_out sipo_scan_out
set_scan_path 2 -scan_data_in piso_scan_in -scan_data_out piso_scan_out
set_scan_path 3 -scan_data_in hv_scan_in -scan_data_out hv_scan_out
set_scan_path 4 -scan_data_in lv_scan_in -scan_data_out lv_scan_out
...
set_port_attributes -ports slice_*/*scan_in* -repeater_supply SS
