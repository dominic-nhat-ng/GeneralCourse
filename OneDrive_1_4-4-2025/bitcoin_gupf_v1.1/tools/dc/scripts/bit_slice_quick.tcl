...
set RESULTS_DIR ./results_bit_slice_quick
set REPORTS_DIR ./reports_bit_slice_quick
...
read_saif -instance_name bitcoin_top/dut/bit_secure_0/slice_0 -input ../vcs_nlp/outputsfromvcs/bit_slice_RTL_UPF.saif -auto_map_names
