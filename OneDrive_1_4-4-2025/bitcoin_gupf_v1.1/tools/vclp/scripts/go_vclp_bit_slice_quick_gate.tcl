...
# READ NETLIST
read_verilog -netlist ../dc/results_bit_slice_quick/${DESIGN_TOP}.vg 
current_design $DESIGN_TOP
link

# LOAD UPF, use report_read to simplify messaging
redirect -file /dev/null {load_upf ../../upf/snps_bit_slice.upf  -supplemental ../dc/results_bit_slice_quick/${DESIGN_TOP}.sup.upf -strict_check false}
report_read
