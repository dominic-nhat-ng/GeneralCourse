...
set_scenario_status -none -setup true -max_transition true -max_capacitance true -dynamic true -active true FUNC_0.78V_SETUP
...
set_scenario_status -none -setup true -max_transition true -max_capacitance true -leakage true -active true FUNC_0.85V_SETUP
set_process_number 1.00
set_voltage 0.85
set_temperature 125
