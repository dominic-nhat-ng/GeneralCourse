...
START_TIMER bs_timer "Starting Bit Slice ICC2 Route"
...
#create_pg_vias -nets  [get_object_name [get_nets $nets_power]] -within_bbox [get_attribute [get_voltage_areas ] bbox]
route_auto
...
STOP_TIMER bs_timer "Completing Bit Slice ICC2 Route"
