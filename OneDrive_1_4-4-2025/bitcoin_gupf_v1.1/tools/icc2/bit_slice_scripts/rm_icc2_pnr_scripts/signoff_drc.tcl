...
START_TIMER bs_timer "Starting Bit Slice ICC2 Signoff DRC"
...
write_verilog -include {pg_netlist} results/bit_slice.vpg
save_upf results/bit_slice.upf


print_message_info -ids * -summary
echo [date] > signoff_drc
GENERATE_REPORTS_SUMMARY
STOP_TIMER bs_timer "Completing Bit Slice ICC2 Signoff DRC"
