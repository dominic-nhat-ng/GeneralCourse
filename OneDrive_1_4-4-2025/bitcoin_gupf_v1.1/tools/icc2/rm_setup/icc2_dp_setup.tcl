...
set SHAPING_CONSTRAINTS_FILE        "./scripts/shaping_constraints_bc.tcl" ;# Will be included as the -constraint_file option for shape_blocks
#set SHAPING_CONSTRAINTS_FILE        "./scripts/j.tcl" ;# Will be included as the -constraint_file option for shape_blocks
...
set PNS_CHARACTERIZE_FLOW          "false"  ;# Perform PG characterization and implementation
set TCL_COMPILE_PG_FILE            "scripts/pg_a.tcl" ;# File should contain all the compile_pg_* commands to create the power networks 
