...
set DCRM_MW_LIBRARY_NAME                                ${DESIGN_NAME}_PHY_LIB
...
set DCRM_SDC_INPUT_FILE                                 $wd/sdc/${DESIGN_NAME}.sdc
...
set DCRM_DCT_DEF_INPUT_FILE                             $wd/def/${DESIGN_NAME}.def
...
# is used.  This requieres an extra Design Compiler Graphical license or a IC Compiler
...
set DCRM_DFT_SIGNAL_SETUP_INPUT_FILE                    $wd/sdc/${DESIGN_NAME}.dft_signal_defs.tcl
...
set DCRM_MV_UPF_INPUT_FILE                              $wd/upf/${DESIGN_NAME}.upf
set DCRM_MV_SET_VOLTAGE_INPUT_FILE                      $wd/sdc/${DESIGN_NAME}.set_voltage.tcl
set DCRM_MV_DCT_VOLTAGE_AREA_INPUT_FILE                 $wd/upf/${DESIGN_NAME}.create_voltage_area.tcl
