...
create_pg_region pp_region1 -polygon {{ 70 1460} {725 1730}}
create_pg_region pp_region2 -polygon {{ 740 1460} {1395 1730}}
create_pg_region pp_region3 -polygon {{ 70 1460} {725 1730}}
create_pg_region pp_region4 -polygon {{ 70 1460} {725 1730}}
create_pg_region pp_region5 -polygon {{ 70 1460} {725 1730}}
create_pg_region pp_region6 -polygon {{ 70 1460} {725 1730}}
create_pg_region pp_region7 -polygon {{ 70 1460} {725 1730}}
...
-layers { {vertical_layer: M8} {width: @width1} {offset: @off1} {spacing: interleaving} {pitch: 162} } 

set y 25
for {set x 0} {$x<1} {incr x} {
  set_pg_strategy mesh_strat_${x} \
  -pg_regions pp_region1 \
  -pattern {{pattern: mesh_pat} {nets: {VDDH }} {parameters: 3 $y} } \
  -extension {{stop: outermost_ring}}
  compile_pg -strategies mesh_strat_${x} -ignore_drc
  set y [expr {$y + 25}]
}
...
for {set x 0} {$x<1} {incr x} {
  set_pg_strategy mesh_strat_${x} \
  -pg_regions pp_region1 \
  -pattern {{pattern: mesh_pat} {nets: {VSS }} {parameters: 3 $y} } \
  -extension {{stop: outermost_ring}}
  compile_pg -strategies mesh_strat_${x} -ignore_drc
  set y [expr {$y + 40}]
}
...
for {set x 0} {$x<1} {incr x} {
  set_pg_strategy mesh_strat_${x} \
  -pg_regions pp_region1 \
  -pattern {{pattern: mesh_pat} {nets: {VDDL }} {parameters: 3 $y} } \
  -extension {{stop: outermost_ring}}
  compile_pg -strategies mesh_strat_${x} -ignore_drc
  set y [expr {$y + 55}]
}
