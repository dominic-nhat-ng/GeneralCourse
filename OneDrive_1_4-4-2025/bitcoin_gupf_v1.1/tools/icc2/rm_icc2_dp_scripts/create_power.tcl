...
START_TIMER BIT_COIN_PG_BUILD "Starting BIT_COIN ICC2 PG Mesh "
...
create_terminal -of_objects [get_shapes -of_objects VDDH]
create_terminal -of_objects [get_shapes -of_objects VDDL]
create_terminal -of_objects [get_shapes -of_objects VSS]
...
create_pg_strap -layer M8 -start 60 -stop 70 -direction vertical -net VSS -width 2 -extend_high outermost_ring -extend_low outermost_ring
create_pg_strap -layer M8 -start 63 -stop 70 -direction vertical -net VDDL -width 2 -extend_high outermost_ring -extend_low outermost_ring
create_pg_strap -layer M8 -start 66 -stop 70 -direction vertical -net VDDH -width 2 -extend_high outermost_ring -extend_low outermost_ring
...
save_lib -all
STOP_TIMER BIT_COIN_PG_BUILD "Completing BIT_COIN ICC2 PG Mesh "
