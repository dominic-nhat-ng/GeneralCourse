...
##########################################################################################
set DESIGN_NAME 		"bit_slice"	;# Name of the design to be worked on
set DESIGN_LIBRARY 		"${DESIGN_NAME}.nlib" ;# Name of the design library, default is ${DESIGN_NAME}.nlib

set REFERENCE_LIBRARY           [list ../lib/stdcell_hvt/ndms/saed32hvt_dlvl_tt0p_v.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_pg_tt_v125c.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_tt_v125c.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_pg_v125c.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_dlvl_v.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_ulvl_tt_v.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_v125c.ndm \
                                      ../lib/stdcell_hvt/ndms/saed32hvt_tt0p_v125c.ndm \
                                      ../lib/stdcell_lvt/ndms/saed32lvt_pg_c.ndm \
                                      ../lib/stdcell_lvt/ndms/saed32lvt_c.ndm \
                                      ../lib/stdcell_lvt/ndms/saed32lvt_dlvl_v.ndm \
                                      ../lib/stdcell_lvt/ndms/saed32lvt_ulvl_v.ndm \
                                      ../lib/stdcell_rvt/ndms/saed32rvt_pg_c.ndm \
                                      ../lib/stdcell_rvt/ndms/saed32rvt_c.ndm \
                                      ../lib/stdcell_rvt/ndms/saed32rvt_dlvl_v.ndm \
                                      ../lib/stdcell_rvt/ndms/saed32rvt_ulvl_v.ndm \
                                      ../lib/sram/ndms/sram2rw16x4_tt1p_v125c.ndm ]
...
#nsgk set VERILOG_NETLIST_FILES       "../../dc/results_bit_slice_quick/bit_slice.vg"
set VERILOG_NETLIST_FILES       "../outputs2icc2/bit_slice.vg"
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is ASCII in icc2_pnr_setup.tcl; not required for DC_ASCII or DP_RM_NDM
#nsgk set UPF_FILE                    "../../dc/results_bit_slice_quick/bit_slice.upf"
set UPF_FILE                    "../../../upf/comb_for_pp.upf"
...
set TECH_FILE 			"$wd/tech/milkyway/saed32nm_1p9m_mw.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
set DC_SUPPLEMENTAL_UPF_FILE 	"../outputs2icc2/bit_slice.sup.upf"	;# A UPF file from Design Compiler

set DEF_FLOORPLAN_FILES		"$wd/def/bs.def"	;# DEF files which contains the floorplan information;
					;# 	for DP: not required
