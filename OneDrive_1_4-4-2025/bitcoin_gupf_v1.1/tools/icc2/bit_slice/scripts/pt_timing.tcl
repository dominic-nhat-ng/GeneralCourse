...
set_eco_options -physical_design_path "./bt_outputs_icc2/chip_finish.def.gz ./bs_outputs_icc2/chip_finish.def.gz ./bc_outputs_icc2/chip_finish.def.gz" -physical_lib_path "$LIB_PATH/lib/stdcell_hvt/lef/saed32nm_hvt_1p9m.lef $LIB_PATH/lib/stdcell_rvt/lef/saed32nm_rvt_1p9m.lef $LIB_PATH/lib/stdcell_lvt/lef/saed32nm_lvt_1p9m.lef $LIB_PATH/lib/sram/ndms/lefs/sram.lef ./bt_outputs_icc2/chip_finish.lef ./bs_outputs_icc2/chip_finish.lef" -physical_tech_lib_path $LIB_PATH/tech/milkyway/tech.lef
