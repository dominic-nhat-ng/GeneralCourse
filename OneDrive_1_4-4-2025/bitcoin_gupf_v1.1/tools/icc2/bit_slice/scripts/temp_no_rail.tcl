...
link
COMMAND_RUNTIME source -e -v upf_dc/snps_bit_coin.upf > logs/snps_bit_coin.upf.log_no_rail_viol
source -e -v scripts/snps_set_voltage.tcl
COMMAND_RUNTIME check_mv_design -verbose > reports/pre_compile_no_rail_viol.cmv.rpt
COMMAND_RUNTIME compile_ultra -no_autoungroup 
COMMAND_RUNTIME check_mv_design > reports/post_compile_no_rail_viol.cmv.rpt
