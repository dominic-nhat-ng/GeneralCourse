...
set_scenario_status -none -setup true -max_transition true -max_capacitance true -active true FUNC_0.78V_SETUP
...
read_sdc ../outputs2icc2/bit_slice.sdc
...
set_scenario_status -none -setup true -max_transition true -max_capacitance true -active true FUNC_0.85V_SETUP
set_process_number 1.00
set_voltage 0.85
set_temperature 125
