...
link
COMMAND_RUNTIME source -e -v upf/snps_bit_coin.upf > logs/snps_bit_coin.upf.log_g_0
source -e -v scripts/snps_set_voltage.tcl
COMMAND_RUNTIME check_mv_design -verbose > reports/pre_compile.cmv.rpt_g_0
COMMAND_RUNTIME compile_ultra -gate_clock -no_autoungroup -no_seq_output_inversion -no_boundary_optimization
COMMAND_RUNTIME check_mv_design > reports/post_compile.cmv.rpt_g_0
