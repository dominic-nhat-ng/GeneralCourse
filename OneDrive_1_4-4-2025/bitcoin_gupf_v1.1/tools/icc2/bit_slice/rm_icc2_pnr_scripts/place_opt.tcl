...
set_app_options -name opt.dft.clock_aware_scan -value false
...
set_app_options -name place.coarse.continue_on_missing_scandef -value 1
...
redirect -tee -file ${REPORTS_DIR}/${PLACE_OPT_BLOCK_NAME}.cmv.rpt {check_mv_design -max_message_count 100}
