...
load_upf bc_outputs_icc2/top_wrapper.upf > logs/load_upf.log
...
report_power > $report_dir/power_average.rpt
#report_power -rails {"VDDL VDDH VDDM" "sipo_sw_out piso_sw_out" "all"} > $report_dir/power_by_rail.rpt
...
source -e -v scripts/extract_data_for_pt.tcl
