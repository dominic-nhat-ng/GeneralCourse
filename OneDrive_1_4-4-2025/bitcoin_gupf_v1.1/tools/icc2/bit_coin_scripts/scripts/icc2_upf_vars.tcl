...
set_app_option -name opt.common.leq_take_opto_dont_touch_libcells -value 1
set_app_option -name cts.multisource.split_power_management_cells -value 1
set_app_option -name cts.multisource.split_ignore_mv_violations -value 1
set_app_options -name opt.common.leq_take_opto_dont_touch_libcells -value true
set_app_options -name cts.multisource.split_power_management_cells -value always
set_app_options -name cts.multisource.split_ignore_mv_violations -value true
