...
set ADDITIONAL_SEARCH_PATH        ". rtl upf verification $LIB_PATH/lib $LIB_PATH/lib/sram/ndms/lib_dbs $LIB_PATH/lib/stdcell_hvt/db_nldm_gm $LIB_PATH/lib/stdcell_lvt/db_nldm $LIB_PATH/lib/stdcell_rvt/db_nldm"
...
set MW_REFERENCE_LIB_DIRS         "$LIB_PATH/lib/stdcell_hvt/milkyway/saed32nm_hvt_1p9m $LIB_PATH/lib/stdcell_rvt/milkyway/saed32nm_rvt_1p9m $LIB_PATH/lib/stdcell_lvt/milkyway/saed32nm_lvt_1p9m $LIB_PATH/lib/sram/milkyway_gmaben/SRAM32NM "  ;#  Milkyway reference libraries (include IC Compiler ILMs here)

set MW_REFERENCE_CONTROL_FILE     ""  ;#  Reference Control file to define the Milkyway reference libs

set TECH_FILE                     "$LIB_PATH/tech/milkyway/saed32nm_1p9m_mw.tf"  ;#  Milkyway technology file
set MAP_FILE                      "$LIB_PATH/tech/milkyway/saed32nm_tf_itf_tluplus.map"  ;#  Mapping file for TLUplus
set TLUPLUS_MAX_FILE              "$LIB_PATH/tech/star_rcxt/saed32nm_1p9m_Cmax.tluplus"  ;#  Max TLUplus file
set TLUPLUS_MIN_FILE              "$LIB_PATH/tech/star_rcxt/saed32nm_1p9m_Cmin.tluplus"  ;#  Min TLUplus file
