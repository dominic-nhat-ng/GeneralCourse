...
START_TIMER bc_timer "Starting Bit Coin ICC2 Route OPT"
...
## set_app_option -block [current_block] -list {time.use_pt_delay true}
## puts "pt_delay is [get_app_option_value -name time.use_pt_delay]"
## 
## lappend search_path .
## lappend search_path /global/gtsna_benchmark3/gmaben/LP_TRAINING_NEW_DESIGN/bit_coin/lib/sram/ndms/lib_dbs
## lappend search_path ../../lib/sram/ndms/lib_dbs 
...
## lappend search_path /global/apps5/star_rcxt_2016.06-SP3/bin
## source scripts/pt_setup.tcl
## 
## 
## # For running Star:
## set_app_options -list {extract.starrc_mode true}
## set_starrc_in_design -config ./scripts/config.txt -keep true
## 
## update_timing -full
## redirect ${report_dir}/pt_delay_calc_star_timer.qor.txt {report_qor -summary -sig 3}
...
STOP_TIMER bc_timer "Completing Bit Coin ICC2 Route OPT"
