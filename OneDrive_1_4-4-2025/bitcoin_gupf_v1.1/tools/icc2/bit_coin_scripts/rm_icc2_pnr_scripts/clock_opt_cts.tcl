...
set stage clock_opt_cts
set report_dir ${REPORTS_DIR}
set_svf ${DESIGN_NAME}_svf -append
START_TIMER bc_timer "Starting Bit Coin ICC2 CTS"
...
#set_hierarchy_options -from_level 0 -enable_planning true
#set_hierarchy_options -to_level 0 -enable_planning true
#set_hierarchy_options -to_level 1 -enable_planning true
#set_hierarchy_options -from_level 1 -enable_planning false
commit_upf
#check_bufferability -net clk -voltage_area DEFAULT_VA

#clock_opt -from build_clock -to route_clock
synthesize_clock_tree
route_group -all_clock_nets -reuse_existing_global_route true
synthesize_clock_tree -postroute -routed_clock_stage detail
...
STOP_TIMER bc_timer "Completing Bit Coin ICC2 CTS"
