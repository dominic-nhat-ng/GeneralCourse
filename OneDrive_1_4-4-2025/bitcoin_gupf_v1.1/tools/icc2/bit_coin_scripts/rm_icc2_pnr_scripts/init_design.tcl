...
START_TIMER bc_timer "Starting Bit Coin ICC2 Init"
        ...
        if {$DESIGN_STYLE == "flat"} {
			...
			source -e create_softlinks_to_subblocks.tcl
                	...
                	## For top or intermediate level of hier designs, open the copied design and do change_abstract
                        echo "OPENING LIB"
                	open_lib ${DESIGN_NAME}.nlib
#                        remove_blocks bit_slice*
#                        remove_blocks bit_top*
#                        set_ref_libs -add $wd/bit_top.nlib
...
STOP_TIMER bc_timer "Completing Bit Coin ICC2 Init"
exit 
