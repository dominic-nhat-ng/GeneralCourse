...
if {[file exists [which $TCL_PHYSICAL_CONSTRAINTS_FILE]]} {
  ...
  ## "-side_length { 5500 1500 } -core_offset 50" Added by Avinash 
   initialize_floorplan -side_length { 5800 1800 } -core_offset 50
  ## End Added by Avinash
  # initialize_floorplan -side_length { 6400 1600 } -core_offset 50
}
...
puts "RM-info : Adding ./bit_top.nlib as a reference of [get_object_name [current_lib]]"
set_ref_libs -add ./bit_top.nlib
commit_block -library bit_top.nlib bit_top
puts "RM-info : Adding ./bit_slice.nlib as a reference of [get_object_name [current_lib]]"
set_ref_libs -add bit_slice.nlib
commit_block -library bit_slice.nlib bit_slice

puts "RM-info : Adding ./bit_slice.nlib as a reference of ./bit_top.nlib"
set_ref_libs -library bit_top.nlib -add bit_slice.nlib
