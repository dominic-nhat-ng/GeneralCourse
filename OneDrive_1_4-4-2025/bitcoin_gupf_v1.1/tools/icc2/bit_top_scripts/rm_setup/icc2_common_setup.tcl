...
##########################################################################################
set DESIGN_NAME 		"bit_top"	;# Name of the design to be worked on
...
set DEF_SCAN_FILE		"outputs2icc2/bit_top.scan_def"	;# A scan DEF file for scan chain information;
...
set PHYSICAL_HIERARCHY_LEVEL	"intermediate" 	;# Specify the current level of hierarchy for the hierarchical PNR flow; top|intermediate|bottom;
					;# 	for hier PNR: required and auto set if unpack_rm_dirs.pl is used; (see README.unpack_rm_dirs.txt for details)
