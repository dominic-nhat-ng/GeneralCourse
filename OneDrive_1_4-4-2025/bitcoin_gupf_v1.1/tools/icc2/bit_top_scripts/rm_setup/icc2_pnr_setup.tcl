...
set TCL_USER_PT_ECO_PRE_SCRIPT ""  	;# An optional Tcl file for pt_eco.tcl to be sourced before sourcing of PT_ECO_CHANGE_LIST.
set TCL_USER_PT_ECO_POST_SCRIPT "" 	;# An optional Tcl file for pt_eco.tcl to be sourced after route_eco.

set PT_ECO_CHANGE_FILE ""		;# ECO guidance file produced by PT-SI write_changes -format icc2tcl or icctcl.
...
##########################################################################################
set search_path [list . ./scripts ./rm_icc2_pnr_scripts ./rm_setup ../bit_slice]
lappend search_path .
...
set SUB_BLOCK_REFS                   	[list bit_slice] ;# Design names of the physical blocks in all levels of physical hierarchy
                                                ;# Include the blocks that will be bound to abstracts
set USE_ABSTRACTS_FOR_BLOCKS        	[list bit_slice] ;# design names of the physical blocks in the next lower level that will be bound to abstracts
