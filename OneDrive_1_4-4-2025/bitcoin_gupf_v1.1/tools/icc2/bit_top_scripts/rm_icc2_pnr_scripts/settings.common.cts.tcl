...
foreach_in_collection m [all_modes] {
        current_mode $m
        set_latency_adjustment_options -reference_clock lclk -clocks_to_update [get_clocks lclk]
        set_latency_adjustment_options -reference_clock hclk -clocks_to_update [get_clocks hclk]
}
