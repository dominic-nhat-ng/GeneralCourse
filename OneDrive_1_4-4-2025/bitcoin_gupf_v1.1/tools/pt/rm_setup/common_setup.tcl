...
set MW_REFERENCE_LIB_DIRS         "$wd/lib/stdcell_hvt/milkyway/saed32nm_hvt_1p9m $wd/lib/stdcell_rvt/milkyway/saed32nm_rvt_1p9m $wd/lib/stdcell_lvt/milkyway/saed32nm_lvt_1p9m $wd/lib/sram/milkyway_gmaben/SRAM32NM "  ;#  Milkyway reference libraries (include IC Compiler ILMs here)

set MW_REFERENCE_CONTROL_FILE     ""  ;#  Reference Control file to define the Milkyway reference libs

set TECH_FILE                     "$wd/tech/milkyway/saed32nm_1p9m_mw.tf.gold"  ;#  Milkyway technology file
set MAP_FILE                      "$wd/tech/milkyway/saed32nm_tf_itf_tluplus.map"  ;#  Mapping file for TLUplus
set TLUPLUS_MAX_FILE              "$wd/tech/star_rcxt/saed32nm_1p9m_Cmax.tluplus"  ;#  Max TLUplus file
set TLUPLUS_MIN_FILE              "$wd/tech/star_rcxt/saed32nm_1p9m_Cmin.tluplus"  ;#  Min TLUplus file
